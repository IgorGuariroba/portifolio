...
export default function ClientProjectView({ data }: ClientProjectViewProps) {
    ...
    >
      <AnimationWrapper className={"py-6 sm:py-16"}>
        <div className="flex flex-col justify-center items-center row-start-2 sm:row-start-1">
          ...
          <svg id="Progresso" width={100} height={100} viewBox="0 0 100 100">
            <circle
              cx={"50"}
              cy={"50"}
              r="30"
                        ...
                        <div className="flex flex-col">
                          ...
                          <div className="grid gap-2 mt-5 grid-cols-2 h-full max-h-[200px] w-full">
                            {item?.technologies.split(",").map((techItem) => (
                              <div key={techItem} className="w-full flex justify-start items-center">
